...
contract PresaleTKING is Ownable,Crowdsale, AllowanceCrowdsale {
    using SafeMath for uint256;

    uint256 _openingTime = now;
    uint256 _closingTime = now + 9 days;
    uint256 _rate = 50000000000;
     address payable _wallet = address(
        0x1Dda5a789d790B3A2132d81821Dd1594C46b59b7
    );
    IERC20 _token = IERC20(0x647503bc732f98b4004f827e70811Cc7C28315b6);
    
    address _tokenWallet = address(0xA54900f1027da179B8F24670FABdB55afA5679fA);

    constructor()
        public
        Crowdsale(_rate, _wallet, _token, _openingTime, _closingTime)
  ...
  function endPresale() public onlyOwner {
        ...
        if(remainingTokens() > 0){
            _token.burnFrom(_tokenWallet, remainingTokens());
        }
    }
