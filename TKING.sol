...
contract TKING is ERC20, Ownable {
    ...
    uint32 public liquidityFee = 200;
    ...
    uint32 public _autoBurn = 200;
    uint32 public _devFee = 100;
    uint32 public _manualBurn = 100;
    uint32 public _marketingFee = 100;
    uint32 public _charityFee = 100;
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = false;

    bool public _paused = false;
    bool public _feesDisabled = true;
    ...
    constructor(
    ...
    ) public ERC20("Tiger King", "TKING") {
        _mint(0xA54900f1027da179B8F24670FABdB55afA5679fA, 1000000000000000 * 10**18);
        
        _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);  // pancake V2
        ...
        _devWallet = 0x2160230B9Df5F0a19253E8EF239f60880bE325eD;
        _manualBurnWallet = 0x2160230B9Df5F0a19253E8EF239f60880bE325eD;
        _marketingWallet = 0xE315f0Ff4d1d69F05e8e18F60C276fc10aF86C1b;
        _charityWallet = 0x32BBaCb0dF70c7a0c4E032cf8Bd5A1Aaf8130829;
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFee[from] && !_feesDisabled && !inSwapAndLiquify) {
            ...
            uint256 devAmount = calculateTokenFee(
              ...
              uint256 marketingAmount = calculateTokenFee(
                amount,
                feeDecimals,
                _marketingFee
            );
              uint256 charityAmount = calculateTokenFee(
                amount,
                feeDecimals,
                _charityFee
            );
            // Avoiding stack too deep erros
            ...
            tokensToTransfer = tokensToTransfer.sub(marketingAmount).sub(charityAmount);
            ...
            super._transfer(from, _marketingWallet, marketingAmount);
            super._transfer(from, _charityWallet, charityAmount);
    ...
    */
        ...
        onlyOwner
    {
      ...
      function setMarketingFee(uint32 newFee)
        public
        onlyOwner
    {
        _marketingFee = newFee;
    }
  function setCharitynFee(uint32 newFee)
        public
        onlyOwner
    {
        _charityFee = newFee;
    ...
    function updateSwapAndLiquifyEnabled(bool _enabled) public onlyOwner {
      ...
      function updateFeesDisabled(bool _enabled) public onlyOwner {
        _feesDisabled = _enabled;
    }
